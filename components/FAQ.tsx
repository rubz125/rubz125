...
export default function FAQ() {
  ...
  return (
    <section id="faq" style={{ padding: "100px 0", background: "#0d1526" }} ref={ref}>
          ...
          {faqs.map((faq, i) => (
            <motion.div key={i}
              ...
              style={{
                ...
                border: `1px solid ${open === i ? "rgba(0,180,216,0.3)" : "rgba(255,255,255,0.07)"}`,
              ...
              <button onClick={() => setOpen(open === i ? null : i)}
                ...
                <span style={{ fontWeight: 600, fontSize: 14, color: "#fff" }}>{faq.q}</span>
              ...
              <AnimatePresence>
                {open === i && (
                  <motion.div
                    ...
                    <div style={{
                      padding: "0 22px 18px", fontSize: 13, color: "#8fa8c8",
                      lineHeight: 1.7, borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: 14,
                    }}>
                      {faq.a}
                    </div>
                  </motion.div>
