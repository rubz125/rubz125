          ...
          >
            ...
            <div className="absolute right-0 top-0 bottom-0 w-80 bg-[var(--bg-surface)] border-l border-[var(--border-sm)] flex flex-col shadow-2xl">
              ...
              <div className="p-6 space-y-3 border-t border-white/10">
                <button
                  onClick={toggleTheme}
                  className="flex items-center justify-center gap-2 w-full py-3 rounded-sm border border-[var(--border-md)] text-[var(--text-2)] font-medium text-sm hover:text-[var(--gold)] hover:border-[var(--border-lg)] transition-colors"
                >
                  {theme === 'dark' ? <Sun className="w-4 h-4" /> : <Moon className="w-4 h-4" />}
