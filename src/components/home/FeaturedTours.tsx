      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <div>
            ...
            >
              Our Most Epic
              <span className="text-gradient-gold"> Safaris</span>
            </motion.h2>
          </div>
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <Link
              href="/tours"
              className="flex items-center gap-2 text-[#D4A843] font-semibold hover:gap-3 transition-all duration-200"
            >
              View All 6 Tours
