      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-[#D4A843] text-sm uppercase tracking-[0.2em] font-medium">Traveler Stories</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              {/* Text */}
              <p className="text-[#A08860] text-sm leading-relaxed flex-1 mb-5">
                &ldquo;{t.text}&rdquo;
              </p>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-white/05">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    <span className="text-[#F5EDD8] font-semibold text-sm truncate">{t.name}</span>
                    <span className="text-sm">{t.flag}</span>
                    {t.verified && (
                      <span className="text-[10px] text-green-400 bg-green-400/10 px-1.5 py-0.5 rounded-sm border border-green-400/20">
                        ✓
                      </span>
                    )}
                  </div>
                  <div className="text-[#7A6245] text-xs">{t.location} · {t.date}</div>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 text-[#D4A843] font-semibold text-sm hover:text-[#F2C464] transition-colors"
          >
            Read All 847 Reviews on TripAdvisor →
          </a>
        </motion.div>
      </div>
    </section>
