...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="py-24 bg-[var(--bg-base)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <span className="text-[var(--gold)] text-sm uppercase tracking-[0.2em] font-medium">{t.gallery_eyebrow}</span>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 text-[var(--text-2)] text-sm hover:text-[var(--gold)] transition-colors"
          >
