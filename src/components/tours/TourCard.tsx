  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-5">
          ...
          <div className="flex">
            {[...Array(5)].map((_, i) => (
              <Star
                ...
                className={cn(
                  'w-3.5 h-3.5',
                  i < Math.floor(tour.rating) ? 'text-[#D4A843] fill-[#D4A843]' : 'text-[#3D2812] fill-[#3D2812]'
                )}
              />
            ))}
          </div>
        ...
        <p className="text-[#7A6245] text-sm mb-4 leading-relaxed line-clamp-2">{tour.shortDescription}</p>
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-[#D4A843]/10">
          <div>
            ...
            <div className="text-[#D4A843] font-bold text-xl leading-none">
              {formatPrice(tour.price, tour.currency)}
            </div>
            <span className="text-[#7A6245] text-xs">per person</span>
          </div>
