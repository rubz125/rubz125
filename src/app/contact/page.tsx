              ...
              <div>
                ...
                <div className="bg-[var(--bg-surface)] border border-[#25D366]/20 rounded-sm p-5">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[var(--text-1)] font-semibold">Fastest response: WhatsApp</span>
                  </div>
                  <p className="text-[var(--text-4)] text-sm mb-3">We typically reply within minutes during business hours.</p>
                  <a
              ...
              <div>
                {sent ? (
                  <div className="h-full flex flex-col items-center justify-center text-center py-16">
                    ...
                    <h3 className="text-2xl font-bold text-[var(--text-1)] mb-3" style={{ fontFamily: 'var(--font-playfair)' }}>Message Sent!</h3>
                    <p className="text-[var(--text-3)] max-w-sm">We'll be in touch within 2 hours. Check your inbox at <strong className="text-[var(--text-2)]">{form.email}</strong>.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <h2 className="text-2xl font-bold text-[var(--text-1)] mb-6" style={{ fontFamily: 'var(--font-playfair)' }}>Send a Message</h2>
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <label className="text-[var(--text-2)] text-sm font-medium mb-2 block">Name</label>
                        <input type="text" required placeholder="Your name" value={form.name} onChange={e => setForm({...form, name: e.target.value})} className="w-full bg-[var(--bg-surface)] border border-[var(--border-md)] text-[var(--text-1)] placeholder-[var(--text-4)] rounded-sm px-4 py-3 text-sm focus:outline-none focus:border-[var(--gold)] transition-colors" />
                      </div>
                      <div>
                    ...
                    <div>
                      <label className="text-[var(--text-2)] text-sm font-medium mb-2 block">Subject</label>
                    ...
                    <div>
                      <label className="text-[var(--text-2)] text-sm font-medium mb-2 block">Message</label>
